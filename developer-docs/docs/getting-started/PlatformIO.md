...
<Frame>
<img src="./ossm/_images/156351539-54a612fd-0b9b-46cb-9e86-2bab2eb65418.webp" alt="PlatformIO sidebar button in VS Code" />
</Frame>

<Frame>
<img src="./ossm/_images/156351872-008e57a4-5e65-40f8-b65c-b663318317d8.webp" alt="PlatformIO Home interface" />
</Frame>

### Step 3: Open the OSSM project


From PlatformIO Home, select "Open Project" and choose the OSSM folder that contains `platformio.ini` (lowercase).

<Frame>
<img src="./ossm/_images/156352091-867148c0-e9bd-47fa-a4e9-7c99c8fce5b1.webp" alt="Open Project dialog in PlatformIO" />
</Frame>

<Frame>
<img src="./ossm/_images/156352222-e3c6c412-248e-40d5-9e7c-d3a895dd0db7.webp" alt="Selecting the OSSM project folder" />
</Frame>
...
### Step 4: Select the correct environment (if applicable)
...
### Step 5: Open the firmware entry point


Open `src/main.cpp` to review the firmware source.

<Frame>
<img src="./ossm/_images/4a687ec9-8110-4500-8ee7-f51c692e2403.webp" alt="main.cpp file in the src directory" />
</Frame>
...
<Frame>
<img src="./ossm/_images/156352700-12fad91c-a8d2-48fa-97cc-ee088d0ff219.webp" alt="Compile and upload buttons in the status bar" />
</Frame>
...
<AccordionGroup>
??? note "Upload fails or board not detected"
...
<Frame>
<img src="./ossm/_images/156354154-c71755e4-d19f-4387-bceb-743403777711.webp" alt="COM port selection in PlatformIO" />
</Frame>
...
??? note "Build fails due to library or platform updates"
...
??? note "Serial monitor shows gibberish"
...
??? note "Stuck in connecting… during upload"
